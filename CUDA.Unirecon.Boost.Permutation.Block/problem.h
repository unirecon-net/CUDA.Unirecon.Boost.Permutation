...
public:
	...
	void AlgTS_neigh_iter(solution &result, const solution sUB, int listN, int iterN);		//jednowatkowy do porownywania
	void AlgTS_neigh_iter_tab(solution &result, const solution sUB, int listN, int iterN);

	//--------- GPU -------//	
	void AlgTSonGPU_neigh_iter(solution &result, const solution sUB, int listN, int iterN, int threadsN);
	void AlgTSonGPU_BaT(solution &result, const solution sUB, int listN, int iterN, int threadsN, int blocksN);	
	void PrintJobs();
